...
public class GameDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<GameType>().HasData(
            ...
            new GameType { Id = 2, Name = "Multiplayer", RoundDuration = 300, IsPromotionEnable = true, RoundPromotionDuration = 15 },
            new GameType { Id = 3, Name = "PartyBattle", RoundDuration = 180, IsPromotionEnable = false, RoundPromotionDuration = 0 },
            new GameType { Id = 4, Name = "RandomEvents", RoundDuration = 300, IsPromotionEnable = true, RoundPromotionDuration = 15 });
